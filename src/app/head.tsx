...
export default function Head() {
  ...
  )});if(cold){var parsedCold=JSON.parse(cold);var answers=parsedCold&&parsedCold.answers;if(answers){var q1=answers.q1;var q2=answers.q2;var q3=answers.q3;var q4=answers.q4;var q1Ok=Array.isArray(q1)?q1.length>0:typeof q1==="string"&&q1.trim().length>0;var q2Ok=typeof q2==="string"&&q2.trim().length>0;var q3Ok=typeof q3==="string"&&q3.trim().length>0;var q4Ok=typeof q4==="string"&&q4.trim().length>0;var ok=q1Ok&&q2Ok&&q3Ok&&q4Ok;if(ok){location.replace("/studio");}}}}}catch(e){}})();`;
